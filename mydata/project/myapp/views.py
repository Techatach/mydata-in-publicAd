...
model = load(r'C:\Users\com059\Desktop\Data\mydata\heartmodel.pkl')
...
def predictor(request):
    if request.method == 'POST':
        ...
        return render(request, 'heartdisease/result.html', {'result':y_pred})
    return render(request, 'heartdisease/forms.html')
